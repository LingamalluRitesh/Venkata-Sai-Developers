...
export const KONDAVEEDU_PROJECT: Project = {
  ...
  tagline: 'Exclusive Villa Plot Venture Just 200 Meters From Historical Kondaveedu Ghat Road',
  category: 'VILLA_PLOTS',
  isUpcoming: false,
  location: 'Kondaveedu Ghat Road, Guntur DT',
  distanceFromGhatRoadMeters: 200,
  priceRangeSqYd: '₹14,500 - ₹18,500 per Sq.Yd',
  ...
  keyFeatures: [
    ...
    'Children Play Park & Avenue Plantation',
